...
public class XOR extends Gate {
    ...
    public XOR() {
        ...
        inputWire[0] = new Rectangle(0, 3, 14, 4);
        inputWire[1] = new Rectangle(0, getHeight() - 8, 14, 4);
    ...
    public void paint(Graphics g) {
        ...
        g.setColor(color);
        g.drawLine(0, getHeight() - 6, 14, getHeight() - 6);

        //chip
        g.setColor(Color.BLACK);
        g.drawArc(2, 0, 2 + getWidth() / 5, getHeight(), -90, 180);
